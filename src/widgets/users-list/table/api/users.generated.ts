...
export type GetUsersListQuery = { __typename?: 'Query', getUsers: { __typename?: 'UsersPaginationModel', users: Array<{ __typename?: 'User', id: number, userName: string, createdAt: any, profile: { __typename?: 'Profile', firstName?: string | null, lastName?: string | null }, userBan?: { __typename?: 'UserBan', reason: string, createdAt: any } | null }>, pagination: { __typename?: 'PaginationModel', page: number, pageSize: number, pagesCount: number, totalCount: number } } };


export const GetUsersListDocument = gql`
    query GetUsersList($pageSize: Int = 10, $pageNumber: Int = 1, $sortBy: String = "createdAt", $sortDirection: SortDirection = desc, $searchTerm: String, $statusFilter: UserBlockStatus = ALL) {
  getUsers(
    pageSize: $pageSize
